...
export MASTER=spark://master:7077              		# Spark master url. eg. spark://master_addr:7077. Leave empty if you want to use local mode.
...
export ZEPPELIN_WEBSOCKET_MAX_TEXT_MESSAGE_SIZE=1024000       # Size in characters of the maximum text message to be received by websocket. Defaults to 1024000
